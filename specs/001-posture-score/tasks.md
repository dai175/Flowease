...
- [X] T022 [US3] PostureViewModel を作成（監視状態管理） in Flowease/ViewModels/PostureViewModel.swift
- [X] T023 [US3] StatusMenuView にカメラ状態表示を統合 in Flowease/Views/StatusMenuView.swift
...
- [X] T030 [US1] MenuBarView にスコア連動アイコン色表示を実装 in Flowease/Views/MenuBarView.swift
- [X] T031 [US1] StatusMenuView に現在スコア表示を追加 in Flowease/Views/StatusMenuView.swift
